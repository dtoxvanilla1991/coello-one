...
export const RETURN_HIGHLIGHTS: ReturnHighlight[] = [
  {
    title: "30-day window",
    description:
      "Log a return within 30 days (45 during the festive season) to stay eligible for full refund or credit.",
  },
  {
    title: "Instant credit",
    description:
      "Choose Coello credit for immediate reuse while your original sleeve travels back to us.",
  },
  {
    title: "Free UK returns",
    description:
      "Standard UK returns ship on us. International labels are subsidised with flat rates.",
  },
];
...
export const RETURN_STEPS: ReturnStep[] = [
  {
    ...
    description:
      "Head to the Return an Item page, enter your order number, and pick refund or exchange.",
  },
  {
    title: "Pack it with care",
    description:
      "Use the original garment bag, remove the security sleeve chip only after we confirm receipt.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Refunds release within 3-5 business days. Exchanges dispatch as soon as your parcel scans.",
  },
];
