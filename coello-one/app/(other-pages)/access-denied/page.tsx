    ...
    <div className="flex grow items-center px-6 xl:px-10">
      <div className="3xl:max-w-[1520px] mx-auto flex w-full max-w-[1180px] flex-col-reverse items-center justify-between text-center lg:flex-row lg:gap-5 lg:text-start">
        ...
        <div className="relative perspective-[1000px]">
          ...
          />
          <div className="bg-gray-1000/50 mx-auto h-20 w-32 rotate-x-80 blur-[57px]"></div>
          <div className="bg-gray-1000/50 absolute bottom-10 left-3 mx-auto h-20 w-32 rotate-x-80 blur-[57px] lg:left-7"></div>
        </div>
      </div>
    </div>
  );
